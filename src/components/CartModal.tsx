...
export default function CartModal() {
	...
	return (
		<Dialog.Portal>
			<Dialog.Overlay className="DialogOverlayCart" />
			<Dialog.Content
				style={{
					top: topPos,
				}}
				className="fixed z-30 bg-white text-blue-very_dark  left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-lg shadow-black/40 w-[95%] max-w-screen-sm"
			>
